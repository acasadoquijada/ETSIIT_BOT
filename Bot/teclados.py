...
teclado_menu = types.ReplyKeyboardMarkup(one_time_keyboard=True,resize_keyboard=True,selective=False)
teclado_menu.add('Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sábado')

# Teclado para elegir el horario
teclado_horario = types.ReplyKeyboardMarkup(one_time_keyboard=True,resize_keyboard=True,selective=False)
teclado_horario.add('Informática', 'Telecomunicaciones', 'Informática + matemáticas')

# Teclado para elegir los examenes
teclado_examenes = types.ReplyKeyboardMarkup(one_time_keyboard=True,resize_keyboard=True,selective=False)
